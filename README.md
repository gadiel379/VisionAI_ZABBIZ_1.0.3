...
```bash
curl -fsSL \
https://raw.githubusercontent.com/gadiel379/VisionAI_ZABBIZ_1.0.3/v1.0.3-r4/install.sh \
| sudo bash
```
...
- Instala únicamente tags publicados, por ejemplo `v1.0.3-r4`; no uses `main` en
